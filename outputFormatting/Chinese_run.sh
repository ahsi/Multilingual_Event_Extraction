...
python format_andrew.py ../../../all_predictions_4.0/currentPredictionsForTriggers/testSet.predictions ../../../preprocessing_2.0/createSetFiles/setFile.withEntities.tmp.Chn andrew.triggers.out
cd ../../
