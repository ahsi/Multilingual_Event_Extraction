...
#            labelTokens = tokens[5].split(".")
            labelTokens = tokens[5].split("_")
            label = labelTokens[0] + "_" + labelTokens[1]

#            output.write("junSystem" + "\t" + tokens[1] + "\t" + tokens[2] + "\t" + tokens[3] + "\t" + tokens[4] + "\t" + tokens[5].lower() + "\t" + tokens[6] + "\n")
#            output.write("hectorSystem" + "\t" + tokens[1] + "\t" + tokens[2] + "\t" + tokens[3] + "\t" + tokens[4] + "\t" + label.lower() + "\t" + tokens[6] + "\n")
            output.write("hectorSystem" + "\t" + tokens[1] + "\t" + tokens[2] + "\t" + tokens[3] + "\t" + tokens[4] + "\t" + label.lower() + "\t" + tokens[6] + "\t" + "0.5" + "\n")
    input.close()
    output.close()
