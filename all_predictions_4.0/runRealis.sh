...
python writeRealisLiblinear.py test ../$2 test.out /home/andrew/DEFT_code_testing/dependencies/models/liblinear/realis.features.dict /home/andrew/DEFT_code_testing/dependencies/models/liblinear/realis.roles.dict ../currentPredictionsForTriggers/testSet.predictions
