...
do
	java -mx16g -cp "$STANFORD_NER/*:$STANFORD_NER/lib/*" edu.stanford.nlp.ie.crf.CRFClassifier -loadClassifier /home/andrew/DEFT_code_testing/dependencies/models/entities/ACE_ERE-English.ner-model.${i}.dependency.full.ser.gz -testfile $1 > code/unify/in/${1}_${i}
done

ls code/unify/in/* > code/unify/in.txt
python code/unify/unifyEntities.py ../createSetFiles/setFile.noEntities.tmp code/unify/in.txt code/unify/out/
...
cd code/
./addEntitiesToText.sh ../../tmp.list ../../CoreNLP_scripts/tmp_Eng/
cd ../
